...
const sidebarItems = [
  ...
  { href: "/report", icon: MapPin, label: "Waste Complaint" },
  { href: "/collect", icon: Trash, label: "Retrieve Waste" },
  { href: "/rewards", icon: Coins, label: "Recognition" },
  { href: "/leaderboard", icon: Medal, label: "Ranking Board" },
];
            ...
            <Link key={item.href} href={item.href} passHref>
              <Button
                ...
                className={`w-full justify-start py-3 ${pathname === item.href
                    ? "bg-purple-100 text-purple-800"  // Changed from purple to purple
